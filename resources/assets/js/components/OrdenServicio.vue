                        ...
                        <table class="table table-bordered table-responsive table-sm">
                            ...
                            <tbody>
                                <tr v-for="cita in arraycita" :key="cita.id">
                                    <td>
                                        <button type="button" v-if="cita.estatus == 1 " @click="mostrarCitaParaOrden(cita)" class="btn btn-warning btn-sm">
                                            <i class="icon-plus"></i>
                                        </button> &nbsp;
                                    </td>
                    ...
                    <div class="card-body">
                                        ...
                                        <tr v-for="(detalle,index) in productoAgregar" :key="detalle.id">
                                            ...
                                            <td>
                                                <select class="form-control" v-model="detalle.cantidad"  > 
                                                    <option  v-for="n in retornaN(detalle.stock)" v-bind:key="n" >{{n}}</option>
                                                </select>
                                            </td>
                                            <td>
                        ...
                        <div class="form-group row">
                            <div class="col-md-12">
                                ...
                                <button type="button" class="btn btn-primary" @click="registrarOrdenServicio()">Registrar Orden</button>
                            </div>
                        </div>
                    </div>
                    </template>
