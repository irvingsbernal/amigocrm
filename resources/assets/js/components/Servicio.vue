            ...
            <div class="container-fluid">
                ...
                <div class="card">
                    <div class="card-header">
                        <i class="fa fa-align-justify"></i> Servicio
                        ...
                        <div class="form-group row">
                            <div class="col-md-6">
                                <div class="input-group">
                                    ...
                                    <input type="text" v-model="buscar" @keyup.enter="listarServicio(1,buscar,criterio)" class="form-control" placeholder="Búsqueda...">
    ...
    export default {
        ...
        methods : {
            ...
            validarServicio(){
                ...
                if (!this.nombre) this.errorMostrarMsjServicio.push("El nombre de la servicio no puede estar vacío.");
