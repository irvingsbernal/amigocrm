                        ...
                        <table class="table table-bordered table-responsive table-sm">
                            ...
                            <tbody>
                                <tr v-for="cita in arraycita" :key="cita.id">
                                    <td>
                                        <button type="button" v-if="cita.estatus == 1" @click="abrirModal('cita','actualizar',cita)" class="btn btn-warning btn-sm">
                                          <i class="icon-pencil"></i>
                                        </button> &nbsp;
                                        <template v-if="cita.estatus == 1">
                ...
                <div class="modal-dialog modal-primary" role="document">
                    <div class="modal-content">
                            ...
                            <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                             <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        ...
                                        <option v-for="sucursal in arraySucursales" :key="sucursal.id" @click="listarHorariosSucursal()" :value="sucursal.id"  v-text="sucursal.nombreComercial"></option>
                                        </select> 
                                    </div>
                                </div>
                                <!-- v-bind:value="{ id: sucursal.id, nombreSucursal: sucursal.nombreComercial, direccion: sucursal.direccion }" -->
                                <div v-if="fk_sucursal != 0">
                                    <div class="form-group row" >
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <select class="form-control" v-model="fk_auto">
                                            <option value="0" disabled>Seleccione--</option>
                                            <option v-for="auto in arrayAutomovil" :key="auto.id" :value="auto.id" v-text="auto.marca+' '+auto.modelo"></option>
                                        </select>  
                                    </div>
                                </div>
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" v-if="tipoAccion==2" class="btn btn-primary" @click="actualizarcita()">Actualizar</button>
                        </div>
                    </div>
                    <!-- /.modal-content -->
                </div>
    ...
    export default {
        ...
        methods : {
            ...
            listarcita (page,buscar,criterio){
                let me=this;
                if(criterio === 'estatus'){
                    if(buscar =='por confirmar'){
                        buscar = 0;
                    }
                    if(buscar == 'confirmadas'){
                        buscar = 1;
                    }
                    if(buscar == 'canceladas'){
                        buscar = 2;
                    }
                    if(buscar == 'atendidas'){
                        buscar = 3;
                ...
                var url= '/cita?page=' + page + '&buscar='+ buscar + '&criterio='+ criterio + '&usuario='+ this.$attrs.id;
                axios.get(url).then(function (response) {
                    var respuesta= response.data;
